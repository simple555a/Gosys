...
template <class T>
class CProxyIPmcDBEvents : public IConnectionPointImpl<T, &DIID_IPmcDBEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	HRESULT Fire_OnAddTag(BSTR name)
	{
	...
	HRESULT Fire_OnDropTag(BSTR names)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnTagModified(BSTR name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnAddGroup(BSTR name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnDropGroup(BSTR name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnGroupModified(BSTR name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnAlarm(INT rank, INT ac, BSTR msg, BSTR sourceHost)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnAddNode(BSTR name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_OnDropNode(BSTR name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
