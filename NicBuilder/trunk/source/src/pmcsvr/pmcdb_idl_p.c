...
typedef struct _pmcdb_idl_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } pmcdb_idl_MIDL_TYPE_FORMAT_STRING;

typedef struct _pmcdb_idl_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } pmcdb_idl_MIDL_PROC_FORMAT_STRING;

typedef struct _pmcdb_idl_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } pmcdb_idl_MIDL_EXPR_FORMAT_STRING;
...
extern const pmcdb_idl_MIDL_TYPE_FORMAT_STRING pmcdb_idl__MIDL_TypeFormatString;
extern const pmcdb_idl_MIDL_PROC_FORMAT_STRING pmcdb_idl__MIDL_ProcFormatString;
extern const pmcdb_idl_MIDL_EXPR_FORMAT_STRING pmcdb_idl__MIDL_ExprFormatString;
...
static const pmcdb_idl_MIDL_PROC_FORMAT_STRING pmcdb_idl__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 260 */	NdrFcShort( 0x2c ),	/* x86 Stack size/offset = 44 */
...
/* 350 */	NdrFcShort( 0x2c ),	/* x86 Stack size/offset = 44 */
...
static const pmcdb_idl_MIDL_TYPE_FORMAT_STRING pmcdb_idl__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_pmcdb_idl_0000_0000, ver. 0.0,
...
static const MIDL_STUBLESS_PROXY_INFO IPmcDB_ProxyInfo =
    {
    &Object_StubDesc,
    pmcdb_idl__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    pmcdb_idl__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _pmcdb_idl_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IPmcDBProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _pmcdb_idl_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IPmcDBStubVtbl,
    0
};
...
const IID *  const _pmcdb_idl_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
