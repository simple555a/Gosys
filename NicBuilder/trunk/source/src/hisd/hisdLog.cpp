...
/*
文件说明：日志记录--用于测试-s命令下的net.exe运行
创建：
    Date        version   Author        Content
    2012-8-15   1.0.0.5   Zander Sun    1.日志记录头文件,将netd中的netLog.cpp照搬过来
	                                    2.日志文件路径改为..\var\hisd—getLogFileName()
改动记录
...
#undef localtime
#endif    
	return get_working_dir() + ("var/hisd/" + std::string(buf));//2012-8-15
}
