...
typedef struct _libpmcdb_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } libpmcdb_MIDL_TYPE_FORMAT_STRING;

typedef struct _libpmcdb_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } libpmcdb_MIDL_PROC_FORMAT_STRING;

typedef struct _libpmcdb_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } libpmcdb_MIDL_EXPR_FORMAT_STRING;
...
extern const libpmcdb_MIDL_TYPE_FORMAT_STRING libpmcdb__MIDL_TypeFormatString;
extern const libpmcdb_MIDL_PROC_FORMAT_STRING libpmcdb__MIDL_ProcFormatString;
extern const libpmcdb_MIDL_EXPR_FORMAT_STRING libpmcdb__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IPmcDB_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IPmcDB_ProxyInfo;
...
static const libpmcdb_MIDL_PROC_FORMAT_STRING libpmcdb__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 328 */	NdrFcShort( 0x43e ),	/* Type Offset=1086 */
...
/* 370 */	NdrFcShort( 0x43e ),	/* Type Offset=1086 */
...
/* 418 */	NdrFcShort( 0x43e ),	/* Type Offset=1086 */
...
/* 478 */	0x8,		/* FC_LONG */
	...
	/* Procedure readArchiveValues */

/* 480 */	0x33,		/* FC_AUTO_HANDLE */
			0x6c,		/* Old Flags:  object, Oi2 */
/* 482 */	NdrFcLong( 0x0 ),	/* 0 */
/* 486 */	NdrFcShort( 0xe ),	/* 14 */
/* 488 */	NdrFcShort( 0x34 ),	/* x86 Stack size/offset = 52 */
...
/* 524 */	NdrFcShort( 0x28 ),	/* x86 Stack size/offset = 40 */
/* 526 */	0x8,		/* FC_LONG */
			0x0,		/* 0 */

	/* Parameter tagValues */

/* 528 */	NdrFcShort( 0x11b ),	/* Flags:  must size, must free, in, out, simple ref, */
/* 530 */	NdrFcShort( 0x2c ),	/* x86 Stack size/offset = 44 */
/* 532 */	NdrFcShort( 0x430 ),	/* Type Offset=1072 */
...
static const libpmcdb_MIDL_TYPE_FORMAT_STRING libpmcdb__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* 1082 */	
			0x12, 0x0,	/* FC_UP */
/* 1084 */	NdrFcShort( 0xfe9e ),	/* Offset= -354 (730) */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    libpmcdb__MIDL_ProcFormatString.Format,
...
/* Object interface: IPmcDB, ver. 0.0,
   GUID={0x5D2076E3,0x68A4,0x4209,{0xB9,0x65,0x45,0xD4,0x8E,0x28,0xC6,0x5A}} */

#pragma code_seg(".orpc")
static const unsigned short IPmcDB_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IPmcDB_ProxyInfo =
    {
    &Object_StubDesc,
    libpmcdb__MIDL_ProcFormatString.Format,
    &IPmcDB_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IPmcDB_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    libpmcdb__MIDL_ProcFormatString.Format,
...
CINTERFACE_PROXY_VTABLE(16) _IPmcDBProxyVtbl = 
{
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::rtdbLock */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::rtdbUnlock */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::readSnapshot */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::writeDevice */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::readArchiveValue */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::readSnapshots */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::writeSnapshots */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::readArchiveValues */ ,
    (void *) (INT_PTR) -1 /* IPmcDB::sleep */
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    libpmcdb__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _libpmcdb_ProxyVtblList[] = 
{
...
const CInterfaceStubVtbl * const _libpmcdb_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IPmcDBStubVtbl,
    0
...
PCInterfaceName const _libpmcdb_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IPmcDB",
    0
...
const IID *  const _libpmcdb_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _libpmcdb_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _libpmcdb, pIID, n)

int __stdcall _libpmcdb_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _libpmcdb, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _libpmcdb, 2, *pIndex )
    
}

const ExtendedProxyFileInfo libpmcdb_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _libpmcdb_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _libpmcdb_StubVtblList,
    (const PCInterfaceName * ) & _libpmcdb_InterfaceNamesList,
    (const IID ** ) & _libpmcdb_BaseIIDList,
    & _libpmcdb_IID_Lookup, 
    2,
    2,
