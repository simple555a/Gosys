...
#ifdef LIBNTSERVICE_EXPORTS
#define LIBNTSERVICE_API _declspec(dllexport)
#else
#define LIBNTSERVICE_API _declspec(dllimport)
#endif


class LIBNTSERVICE_API CNTService {
...
LIBNTSERVICE_API CNTService * AfxGetService();
