...
procedure create_f8_uuid(id : pf8_uuid);cdecl; external 'libCPres.dll';

procedure f8_uuid_to_string(
	id : pf8_uuid;
	buf : pchar;
	length : f8_int
	);cdecl; external 'libCPres.dll';
...
function load_res_stream(
	s : PStream
	):f8_bool;cdecl;external 'libCPres.dll';
...
function get_res_name(
	id : pf8_uuid
	):pchar;cdecl;external 'libCPres.dll';
...
function get_res_int(
	...
	key : pchar;
	defval : f8_int
	):f8_int;cdecl;external 'libCPres.dll';
...
function query_resource(id : Pf8_uuid):f8_int;cdecl;external 'libCPres.dll';
